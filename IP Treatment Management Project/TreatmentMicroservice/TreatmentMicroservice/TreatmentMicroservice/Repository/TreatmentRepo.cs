...
namespace TreatmentMicroservice.Repository
{
    public class TreatmentRepo : ITreatmentRepo
    {
        ...
        public TreatmentRepo(TreatmentContext context,IConfiguration config)
        {
            ...
            _context.Plans.AddRange(
                  new TreatmentPlan{
                      PlanId = 1,AilmentName = "Orthopaedics",PackageName = "Package 1",TestDetails = "OPT1,OPT2",Cost = 2500,SpecialistName = "Shriny"
                  },
                  new TreatmentPlan{
                      PlanId = 2,AilmentName = "Orthopaedics",PackageName = "Package 2",TestDetails = "OPT3,OPT4",  Cost = 3000,SpecialistName = "Joey"
                  },
                  new TreatmentPlan{
                        PlanId = 3,AilmentName = "Urology",PackageName = "Package 1",TestDetails = "UPT1,UPT2",Cost = 4000,SpecialistName = "Chandler",
                  },
                  new TreatmentPlan{
                        PlanId = 4,AilmentName = "Urology",PackageName = "Package 2",TestDetails = "UPT3,UPT4",Cost = 5000,SpecialistName = "Rachel",
                  }
               );
            ...
            uriConn = _config.GetValue<string>("Link:offeringUri");
        }
